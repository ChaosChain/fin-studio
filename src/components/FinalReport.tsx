    ...
    return (
      <div className="space-y-6">
                ...
                {dkgNodes.length === 0 && (
                  <div className="mb-4 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                    <p className="text-sm text-yellow-800">
                      ...
                      <br />• Investment recommendations and risk factors
                    </p>
                  </div>
                )}
                          ...
                          <div className="mt-3 p-3 bg-orange-50 rounded-lg border-l-4 border-orange-500">
                            ...
                            <div className="space-y-2 text-xs">
                              ...
                              {analysis.actualAnalysis.recommendations && analysis.actualAnalysis.recommendations.length > 0 && (
                                <div>
                                  <strong>Investment Strategy Recommendations:</strong>
                                  <ul className="ml-4 mt-1">
              ...
              {analysisInsights.insights.length > 0 ? (
                <div className="space-y-4">
                        ...
                        {analysis.actualAnalysis && analysis.consensus && (
                          <div className="mt-3 p-3 bg-green-50 rounded-lg border-l-4 border-green-500">
                            ...
                            <div className="space-y-2 text-xs">
                              ...
                              {analysis.actualAnalysis.recommendations && analysis.actualAnalysis.recommendations.length > 0 && (
                                <div>
                                  <strong>Actionable Investment Recommendations:</strong>
                                  <ul className="ml-4 mt-1">
                                    {analysis.actualAnalysis.recommendations.slice(0, 3).map((rec: string, idx: number) => (
                  ...
                  <div className="mt-4 p-4 bg-green-50 rounded-lg">
                    <h4 className="font-semibold text-green-800 mb-2">Investment Recommendations:</h4>
                    <ul className="text-sm text-green-700 space-y-1">
                      <li>• Synthesized insights from all analysis components</li>
                      <li>• Actionable investment recommendations</li>
        ...
        <Card className="border-2 border-indigo-200 bg-indigo-50">
          <CardHeader>
            <CardTitle className="text-indigo-800">🎯 Final Investment Recommendations</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="bg-white p-6 rounded-lg">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="text-center">
                  <div className="text-3xl font-bold text-indigo-600 mb-2">
                    {overallStatus.rate >= 75 ? 'BUY' : overallStatus.rate >= 50 ? 'HOLD' : 'CAUTION'}
                  </div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <ul className="text-sm text-gray-700 space-y-1">
                    <li>• This analysis is generated by AI and should not be considered financial advice</li>
